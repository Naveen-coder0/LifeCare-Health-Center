                ...
                <div className="container-clinic mx-auto px-4 max-w-4xl">
                    ...
                    <div className="prose prose-slate max-w-none prose-headings:font-heading prose-headings:font-bold prose-a:text-primary">
                        ...
                        <section className="space-y-6">
                            ...
                            <p>
                                By accessing and using the Medstar Multispecialty Clinic website and services, you accept and agree to be bound by the terms and provision of this agreement.
                            </p>
                            ...
                            <p>
                                Medstar Multispecialty Clinic shall not be liable for any direct, indirect, incidental, or consequential damages resulting from the use or inability to use the site or services.
                            </p>
                        </section>
                    </div>
                </div>
